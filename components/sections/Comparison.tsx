  ...
  return (
    <section className="py-24">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div
          className="mt-14 w-full overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm"
          style={{ maxWidth: "100%" }}
        >
          ...
          >
            ...
            <div className="border-l border-gray-100 p-4 font-semibold text-gray-700">
              Klassischer Kanal
            </div>
            <div className="border-l border-gray-100 bg-blue-50 p-4 font-semibold text-gray-700">
              FINN Portal
            </div>
          </div>
          {rows.map((row) => (
            <div
              ...
              style={{ gridTemplateColumns: "25% 37.5% 37.5%" }}
            >
              <div className="flex items-center p-4 text-sm font-medium text-gray-600">
                {row.label}
              </div>
              <div className="flex items-center gap-2 border-l border-gray-100 p-4 text-sm text-gray-600">
                <span className="shrink-0 text-slate-400">
                  <CrossIcon className="h-5 w-5" />
                </span>
                {row.klassisch}
              </div>
              <div className="flex items-center gap-2 border-l border-gray-100 bg-blue-50 p-4 text-sm font-medium text-gray-900">
