...
export function Hero() {
  ...
  return (
    <section className="bg-white pt-32 pb-16 sm:pt-40 sm:pb-20">
      <div className={`mx-auto px-4 text-center sm:px-6 ${locale === 'de' ? 'max-w-5xl' : 'max-w-4xl'}`}>
        ...
        <p className={`mx-auto mt-6 text-lg text-gray-500 sm:text-xl ${locale === 'de' ? 'max-w-3xl' : 'max-w-2xl'}`}>
